/**
 * welcome to RPSLS level 4,
 * This level included ai
 * for reading the code purposes I did not use any methods inside rock()... 
 * for understanding how this ai works, just read rock() and maybe spock() spock is the special weapon in for this ai.
...
public class level4 {
    ...
    static int 
    win_max_chance = 70,
    win_max_value_stay = 50,
    win_min_chance = 70,
    win_min_value_stay = 50,
    ...
    lose_max_chance = 10,
    lose_max_value_stay = 15,
    lose_min_chance = 10,
    lose_min_value_stay = 15;
